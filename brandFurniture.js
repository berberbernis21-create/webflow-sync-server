...
export const BRAND_KEYWORDS = {
  // Core premium / legacy
  "Pottery Barn Teen": ["pottery barn teen", "pb teen"],
  "Pottery Barn Kids": ["pottery barn kids", "pb kids"],
  "Pottery Barn": ["pottery barn", "pb"],
  "Crate & Barrel": ["crate & barrel", "crate and barrel", "crate & barrell"],
  "CB2": ["cb2"],
  "Restoration Hardware": ["restoration hardware", "rh", "rh modern", "rh baby & child"],
  "West Elm": ["west elm"],
  "Room & Board": ["room & board", "room and board"],
  ...
  "Universal Furniture": ["universal furniture", "universal"],
  "Kincaid": ["kincaid"],
  "Century Furniture": ["century furniture", "century"],
  "Hickory Chair": ["hickory chair"],
  "Flexsteel": ["flexsteel"],
  "Bassett": ["bassett", "bassett furniture"],
  "Henkel Harris": ["henkel harris"],
  "Havertys": ["havertys"],
  "Sligh": ["sligh"],
  ...
  "Mitchell Gold + Bob Williams": ["mitchell gold", "mg+b", "mitchell gold bob williams", "mg&b"],
  "Lamps Plus": ["lamps plus"],
  "Regency": ["regency lighting"],

  // Pottery / art / mirrors
  "McCarty Pottery": ["mccarty pottery", "mccarty"],
  "Villeroy & Boch": ["villeroy & boch", "villeroy and boch"],
  "Waterford": ["waterford"],
  "Wedgwood": ["wedgwood"],
  "Spode": ["spode"],
  "Lenox": ["lenox"],
  ...
  "Design Within Reach": ["design within reach", "dwr"],
  "Arhaus": ["arhaus"],
  ...
  "Ashley Furniture": ["ashley", "ashley furniture"],
  "Raymour & Flanigan": ["raymour", "raymour & flanigan"],
  "Living Spaces": ["living spaces"],
  "Rooms To Go": ["rooms to go"],
  "Bob's Discount Furniture": ["bob's", "bobs discount furniture", "bobs"],
  ...
  "Thuma": ["thuma"],
  "Floyd": ["floyd"],
  "Serena & Lily": ["serena & lily", "serena and lily"],
  ...
  "Ballard Designs": ["ballard designs", "ballard"],
