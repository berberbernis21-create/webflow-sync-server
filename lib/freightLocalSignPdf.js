/**
 * One-page branded local delivery document for the customer to sign.
...
import { formatCustomerAssemblyTimeLabel, LOST_FOUND_PHONE } from "./freightPalletize.js";
...
export async function generateLocalSignPdf(submission, ctx = {}) {
  ...
  const rateNote = localEstimate?.oversize_confirm
    ...
    : Number(submission.access?.extra_people) >= 1
      ...
      : assemblyFeeAmt > 0 && assemblyTimeLabel
  ...
  return new Promise((resolve, reject) => {
    ...
    const disclosureText = [
      ...
      "Estimated disassembly & reassembly time from the online questionnaire is included in this estimate when answered. Full furniture installation, electrical, plumbing, gas, wall anchoring, and any utility or fixture work are NOT included and are NOT the responsibility or liability of Lost & Found.",
