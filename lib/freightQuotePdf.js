...
export function nonAccessReviewReasons(reasons = []) {
  const accessLike =
    /stairs|movers|elevator|tight turns|narrow hall|long carry|inside delivery|room placement|unpacking|debris|disassembly|assembly|parking|fragile|special handling|gated access|liftgate|extra person|two trucks|oversized|round trip over/i;
