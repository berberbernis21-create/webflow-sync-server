...
import { formatInternalAssemblyFeeDetail, formatCustomerAssemblyTimeLabel, isArizonaStateOrZip } from "./freightPalletize.js";
  ...
  if (isLocal && Number(localEstimate?.assembly_fee) > 0) {
    requestLeft.push([
      ...
      audience === "internal"
        ...
        : formatCustomerAssemblyTimeLabel(localEstimate.assembly_extra_minutes) ||
