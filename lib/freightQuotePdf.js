...
import { formatInternalAssemblyFeeDetail, formatCustomerAssemblyTimeLabel, customerAssemblyTimeLines, isArizonaStateOrZip } from "./freightPalletize.js";
    ...
    (() => {
      ...
      if (req === "yes") {
        ...
        if (over === "yes") {
          ...
          if (lines) {
            return `Additional ${lines.extraLabel} · Total ${lines.totalLabel}`;
          }
          return "Yes";
        }
