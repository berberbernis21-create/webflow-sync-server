...
const FURNITURE_POLICY_SECTIONS = [
  {
    title: "Consignment Terms",
    paragraphs: [
      "Consignment is a 50/50 split between consignor and Lost & Found Resale Interiors, LLC on a standard 90-day agreement. After acceptance, we send digital contracts and related paperwork by email for your review and signature.",
      "Accepted furniture and home pieces are generally priced at 30-50% of estimated retail value, based on condition, demand, and our pricing standards. Retail references and online comparables you provide are helpful but not guaranteed; we verify pricing, condition, and market demand in person before finalizing showroom tags and contracts.",
      ...
      "Each agreement runs for 90 days with a 7-day grace period when the term ends. If items remain unsold after the contract period, you may retrieve them (by appointment), donate them where offered, or request an extension. Approved extensions may use a 65/35 consignor/store split for the extended term; details are confirmed in writing.",
      "Credit card sales may include a 3% processing fee where applicable. If professional cleaning is required before we can merchandise an item, a $25 cleaning fee may apply (we communicate this before proceeding). Discounting is not automatic; we may discuss adjustments after 30 days (up to ~15%) or 60 days (up to ~35%) depending on the item and market.",
      ...
      "After your items are accepted, we follow up by email with next steps. Third-party delivery, freight, and donation pickup companies are independent contractors unless otherwise agreed in writing.",
    ],
  },
  {
    title: "Our Handbag Division",
    paragraphs: [
      "Lost & Found Resale Handbags is our dedicated luxury division for authenticated designer handbags, accessories, and fine jewelry at lostandfoundhandbags.com.",
    ],
  },
];
