...
const BRANDS = {
  furniture: {
    ...
    customerPricingParagraph:
      "Pricing is confirmed after acceptance, intake, and an in-person review of your submitted items, and will be outlined in the consignment agreement we send you. We price items at 30-50% of retail, depending on condition, brand, demand, and presentation.",
    ...
    pdfPoliciesIntro:
      "If your submission is accepted, we will email you with next steps. After we coordinate intake and an in-person review of your submitted items, you will receive our full Consignment Agreement for review and signature. Your agreement will include confirmed pricing, your contract start date, and the full terms of consignment. The overview below summarizes key points for your reference in the meantime. Submitting this form does not guarantee acceptance.",
  },
  handbags: {
    key: "handbags",
