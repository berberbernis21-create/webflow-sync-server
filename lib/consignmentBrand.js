...
const BRANDS = {
  furniture: {
    ...
    aboutParagraphs: [
      "Lost + Found Resale Interiors is a curated Scottsdale showroom for furniture, decor, art, lighting, rugs, mirrors, and select designer pieces—not a basic drop-off model. We review each submission for condition, style, demand, brand or maker value, and showroom fit before intake.",
      "When your items are accepted, they may be presented in our showroom, listed online, surfaced in Google Shopping and Search, and promoted through social channels that help reach serious buyers.",
      "Our standard consignment term is 90 days with a 50/50 split of the final selling price. Credit card and online channel sales may include an applicable processing fee of approximately 3% of the final sales price.",
    ],
    shopLinks: [
...
const FURNITURE_POLICY_SECTIONS = [
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Lost & Found may discount consigned items as follows: between 5% and 15% for promotional reasons or to reflect online processing; between 15% and 20% after 30 days; and up to 35% after 60 days, at Lost & Found's discretion.",
