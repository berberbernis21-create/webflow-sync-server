 ...
 */
export async function generateCustomerConsignmentPdf({ body, items, photoGroups, submittedAt }) {
  const pdfPhotoGroups = await preparePhotoGroupsForPdf(photoGroups);
