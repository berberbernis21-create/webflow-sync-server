...
function drawPageWatermark(doc) {
  ...
  doc.text("Resale Interiors", cx - 210, cy + 26, { width: 420, align: "center" });
  doc.restore();
}
...
function drawHeaderBar(doc) {
  ...
  doc.fillColor(COLOR_ACCENT).font("Helvetica-Bold").fontSize(14).text("Resale Interiors", MARGIN, 42, {
    characterSpacing: 0.6,
  });
  doc.font("Helvetica").fontSize(8).fillColor("#d4ccc4").text("Scottsdale, Arizona", MARGIN, 60);
  doc.restore();
