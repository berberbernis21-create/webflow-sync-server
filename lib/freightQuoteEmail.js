...
export function buildFreightQuoteEmails(submission, ctx = {}) {
  ...
  const timingNoteHtml = isLocal
    ? isPickup
      ? `<p style="margin:0 0 12px;padding:12px 14px;background:#f4f7fb;border-left:4px solid #1f4e79;font-size:14px;line-height:1.55;color:#333;"><strong>Typical timing:</strong> Same-day pickup is possible; most pickups are next-day. Provide your preferred days and windows — we use your preferred delivery request and expedite.</p>`
      : `<p style="margin:0 0 12px;padding:12px 14px;background:#f4f7fb;border-left:4px solid #1f4e79;font-size:14px;line-height:1.55;color:#333;"><strong>Typical timing:</strong> Same-day delivery is possible; most items are next-day after purchase. Provide your preferred days and windows — we use your preferred delivery request and expedite.</p>`
  ...
  const timingNoteText = isLocal
    ? isPickup
      ? "Typical timing: Same-day pickup is possible; most pickups are next-day. Provide your preferred days and windows — we use your preferred delivery request and expedite."
      : "Typical timing: Same-day delivery is possible; most items are next-day after purchase. Provide your preferred days and windows — we use your preferred delivery request and expedite."
