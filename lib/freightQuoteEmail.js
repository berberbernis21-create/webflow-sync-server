...
export function buildFreightQuoteEmails(submission, ctx = {}) {
  ...
  function localRateConfirmHtml({ strong = false } = {}) {
    ...
    return [
      ...
      `<p style="margin:0 0 16px;font-size:14px;line-height:1.55;color:#333;">This is our <strong>best guess</strong> based on the information you provided — not a locked-in rate. Please call to confirm before scheduling.</p>`,
  ...
  function localRateConfirmText() {
    return [
      ...
      "This is our best guess based on the information you provided — not a locked-in rate. Please call to confirm before scheduling.",
  ...
  const confirmDueSizeHtml = oversizeConfirm
    ? `<p style="margin:0 0 10px;padding:12px 14px;background:#fff1f0;border-left:4px solid #c0392b;font-size:14px;line-height:1.55;color:#333;"><strong>Needs confirmation due to item size.</strong> At least one item is 299+ lb or over 72&quot; high or 72&quot; wide. Please contact us before scheduling. <strong>This is an estimate only.</strong></p>`
    : "";

  const confirmDueDistanceHtml = longHaulConfirm
    ? `<p style="margin:0 0 10px;padding:12px 14px;background:#fff1f0;border-left:4px solid #c0392b;font-size:14px;line-height:1.55;color:#333;"><strong>Needs confirmation — out of town (100+ mile round trip).</strong> Please contact us to confirm before scheduling. <strong>This is an estimate only.</strong></p>`
    : "";
  ...
  const customerHtml = wrapEmail(
    [
      ...
      isLocal
        ? `<p style="margin:0 0 14px;font-size:14px;color:#444;"><strong>(Estimate)</strong> Preliminary estimate only — not a booking. Access, labor, stairs, crew size, and scheduling can change the final amount. Call the shop for final rate confirmation.</p>`
  ...
  const customerText = [
    ...
    localPriceDisplay
      ? `${estimateAmountLabel}\n${localPriceDisplay} (Estimate)${
          oversizeConfirm
            ? "\nNeeds confirmation due to item size (299+ lb or over 72\" H or over 72\" W). Please contact us before scheduling. ESTIMATE ONLY."
            : ""
        }${
          longHaulConfirm
