...
export function buildFreightQuoteEmails(submission, ctx = {}) {
  ...
  const timingNoteHtml = isLocal
    ? isPickup
      ? `<p style="margin:0 0 12px;padding:12px 14px;background:#f4f7fb;border-left:4px solid #1f4e79;font-size:14px;line-height:1.55;color:#333;"><strong>Typical timing:</strong> Same-day is sometimes possible early in the day; most local pickups are next-day. we use your preferred delivery request and expedite.</p>`
      : `<p style="margin:0 0 12px;padding:12px 14px;background:#f4f7fb;border-left:4px solid #1f4e79;font-size:14px;line-height:1.55;color:#333;"><strong>Typical timing:</strong> Same-day is sometimes possible early in the day; most local items are next-day after purchase. Provide your preferred delivery days — we use your preferred delivery request and expedite.</p>`
    : `<p style="margin:0 0 12px;padding:12px 14px;background:#f4f7fb;border-left:4px solid #1f4e79;font-size:14px;line-height:1.55;color:#333;"><strong>Typical timing:</strong> Nationwide freight is typically 3–5 business days after booking. we use your preferred delivery request and expedite once the item is purchased.</p>`;

  const timingNoteText = isLocal
    ? isPickup
      ? "Typical timing: Same-day is sometimes possible early in the day; most local pickups are next-day. we use your preferred delivery request and expedite."
      : "Typical timing: Same-day is sometimes possible early in the day; most local items are next-day after purchase. Provide your preferred delivery days — we use your preferred delivery request and expedite."
    : "Typical timing: Nationwide freight is typically 3–5 business days after booking. we use your preferred delivery request and expedite once the item is purchased.";
