...
function nationwideInternalPlaybookHtml(submission = {}) {
  ...
  return [
    ...
    `<p style="margin:0 0 12px;font-size:13px;line-height:1.5;color:${MUTED};">Ready to forward to Luke (and CC the customer if helpful).</p>`,
    ...
    `<li style="margin:0 0 8px;"><strong>Forward this email to Luke</strong> at <a href="mailto:${FREIGHTCENTER_LUKE_EMAIL}" style="color:${NAVY};font-weight:700;">${FREIGHTCENTER_LUKE_EMAIL}</a> and ask for options: cheapest, best/quality, and warehouse pickup. Stick with Luke’s recommendation when quoting the customer.</li>`,
    `</ol>`,
    palletFitHtml,
...
function nationwideInternalPlaybookText(submission = {}) {
  ...
  return [
    ...
    "Ready to forward to Luke (and CC the customer if helpful).",
    "1) FreightCenter quote SOP is in Dropbox (Shopify → Freight Shipping).",
    `2) Forward this email to Luke Rogers <${FREIGHTCENTER_LUKE_EMAIL}> and ask for options: cheapest, best/quality, and warehouse pickup. Stick with Luke's recommendation when quoting the customer.`,
    "",
    palletFit,
    "",
    "PACKING DETAILS",
    ...
    isLocal && localEstimate?.estimated_price != null
      ...
      : isLocal
        ...
        : [
            ...
            [
              "Note",
              `Forward to Luke (${FREIGHTCENTER_LUKE_EMAIL}) · SOP in Dropbox · floor $350`,
            ],
          ];
