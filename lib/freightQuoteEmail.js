...
function nationwideInternalPlaybookHtml(submission = {}) {
  ...
  return [
    ...
    `<p style="margin:0 0 8px;font-size:13px;font-weight:800;color:${NAVY};">Nationwide — next step</p>`,
    `<p style="margin:0 0 10px;font-size:14px;line-height:1.55;color:#222;"><strong>Forward this email to Luke</strong> at <a href="mailto:${FREIGHTCENTER_LUKE_EMAIL}" style="color:${NAVY};font-weight:700;">${FREIGHTCENTER_LUKE_EMAIL}</a> and ask him for a <strong>confirmed quote</strong>. Everything he needs is already in this message (items, stacking/pallet entry, access, and what the customer said).</p>`,
    `<p style="margin:0 0 12px;font-size:12px;line-height:1.5;color:${MUTED};">Optional reference if needed: SOP + FreightCenter login in <strong>${escapeHtml(
      FREIGHTCENTER_SOP_PATH
    )}</strong> · ${escapeHtml(FREIGHTCENTER_PHONE)}</p>`,
    `<p style="margin:0 0 6px;font-size:12px;font-weight:800;color:${INK};">Packing / stacking (included for Luke)</p>`,
    ...
    `<p style="margin:0;font-size:12px;line-height:1.55;color:#333;">Cheaper carriers often mean slower communication and more billing adjustments — ~95% of the time you get what you pay for.</p>`,
    `</div>`,
  ].join("");
}
...
function nationwideInternalPlaybookText(submission = {}) {
  ...
  return [
    ...
    `Forward this email to Luke Rogers <${FREIGHTCENTER_LUKE_EMAIL}> and ask for a confirmed quote.`,
    `Everything needed is in this message. Optional: SOP/login at ${FREIGHTCENTER_SOP_PATH}. Phone: ${FREIGHTCENTER_PHONE}.`,
    "",
    ...
    "REMINDER — cheaper carriers often = slower communication + more billing adjustments; ~95% of the time you get what you pay for.",
  ].join("\n");
}
