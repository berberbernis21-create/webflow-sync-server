...
export function buildFreightQuoteEmails(submission, ctx = {}) {
  ...
  const estimateRows =
    isLocal && localEstimate?.estimated_price != null
      ? [
          ...
          isPickup ? ["Direction", "From consignor address → Scottsdale showroom"] : null,
        ].filter(Boolean)
      : isLocal
  ...
  const driveExplainHtml =
    isLocal && oneWayMinutes != null
      ? `<p style="margin:0 0 14px;font-size:14px;color:#444;">This estimate considers <strong>${oneWayMinutes} minutes one way (${roundTripMinutes} minutes round trip)</strong>${
          ...
          isPickup
            ? "from your pickup location to our Scottsdale showroom and back, loading the item at your location, securing it for transport, unloading it at our showroom, and the expected time and labor."
      ...
      : isLocal
        ? `<p style="margin:0 0 14px;font-size:14px;color:#444;">This estimate considers ${
            isPickup
              ? "the drive from your pickup location to our Scottsdale showroom and back, loading the item at your location, securing it for transport, unloading it at our showroom, and the expected time and labor."
  ...
  const driveExplainText =
    isLocal && oneWayMinutes != null
      ...
      : isLocal
        ? isPickup
          ? "This estimate considers the drive from your pickup location to our Scottsdale showroom and back, loading the item at your location, securing it for transport, unloading it at our showroom, and the expected time and labor."
