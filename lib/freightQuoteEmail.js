...
export function buildFreightQuoteEmails(submission, ctx = {}) {
    ...
    isLocal && oneWayMinutes != null
      ...
      : isLocal
        ...
        : `<p style="margin:0 0 14px;font-size:14px;color:#444;">${
          ...
          }This preliminary range is based on measured distance, pallet dimensions and weight, residential/commercial delivery, liftgate, and handling needs. Nationwide freight is never quoted below <strong>$350</strong>; white-glove services can increase the upper end.</p>`;
      ...
      : isLocal
        ...
        : `${
            nationwideMiles != null
              ...
              : "Distance will be confirmed when we review your request. "
          }This preliminary range is based on measured distance, pallet dimensions and weight, residential/commercial delivery, liftgate, and handling needs. Nationwide freight is never quoted below $350; white-glove services can increase the upper end.`;
  ...
  const customerHtml = wrapEmail(
    [
      ...
      isLocal
        ? ""
        : `<p style="margin:0 0 12px;font-size:14px;color:#444;"><strong>This is an estimate only.</strong> We will follow up with better rates after we review your request and contact our freight partners for an exact quote. Confirmed carrier pricing and the Shipment ID come after that review. You can also reach FreightCenter at ${FREIGHTCENTER_PHONE} once we provide that ID.</p>`,
  ...
  const customerText = [
    ...
    !isLocal
      ? "This is an estimate only. We will follow up with better rates after we review your request and contact our freight partners for an exact quote."
      : null,
    "",
    "Your item(s):",
