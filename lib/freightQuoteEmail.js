...
export function buildFreightQuoteEmails(submission, ctx = {}) {
  ...
  function localRateConfirmHtml({ strong = false } = {}) {
    ...
    return [
      ...
      `<p style="margin:0 0 8px;font-size:15px;font-weight:800;color:#8a6d12;letter-spacing:0.03em;text-transform:uppercase;">Confirm pricing before scheduling</p>`,
      `<p style="margin:0 0 16px;font-size:14px;line-height:1.55;color:#333;">This is an <strong>estimate from our online tool</strong> — not a locked-in rate. Confirm pricing before scheduling. A PDF of what you submitted is attached — review your questions and make sure they are accurate when you call to confirm.</p>`,
      ...
      `<a href="tel:+1${cruzTel}" style="text-decoration:none;"><img src="${BRAND.cruzLogo}" alt="${CRUZ_PRO_LINE_NAME}" width="72" height="72" style="display:block;width:72px;height:72px;border-radius:10px;object-fit:cover;" /></a>`,
      `</td>`,
      ...
      `<p style="margin:0;font-size:16px;font-weight:800;color:${NAVY};"><a href="tel:+1${cruzTel}" style="color:${NAVY};text-decoration:none;">${CRUZ_PRO_LINE_NAME}</a></p>`,
      `<p style="margin:4px 0 0;font-size:18px;font-weight:800;"><a href="tel:+1${cruzTel}" style="color:${INK};text-decoration:underline;">${CRUZ_PRO_LINE_PHONE}</a></p>`,
      `</td></tr></table>`,
      `</td></tr>`,
      ...
      `<a href="tel:+1${shopTel}" style="text-decoration:none;"><img src="${BRAND.storePhoto}" alt="Lost &amp; Found Scottsdale showroom" width="88" height="88" style="display:block;width:88px;height:88px;border-radius:10px;object-fit:cover;border:1px solid #e5e1d8;" /></a>`,
      `</td>`,
      `<td style="vertical-align:middle;padding-left:12px;">`,
      ...
      `<p style="margin:0;font-size:16px;font-weight:800;color:${NAVY};"><a href="tel:+1${shopTel}" style="color:${NAVY};text-decoration:none;">Lost &amp; Found Resale</a></p>`,
      `<p style="margin:4px 0 0;font-size:18px;font-weight:800;"><a href="tel:+1${shopTel}" style="color:${INK};text-decoration:underline;">${LOST_FOUND_PHONE}</a></p>`,
      `<p style="margin:6px 0 0;font-size:12px;color:#666;">Scottsdale showroom · confirm pricing before scheduling</p>`,
      `</td></tr></table>`,
      `</td></tr>`,
      `</table>`,
      `</div>`,
  ...
  function localRateConfirmText() {
    return [
      "Confirm pricing before scheduling.",
      "This is an estimate from our online tool — not a locked-in rate. A PDF of what you submitted is attached — review your questions and make sure they are accurate when you call to confirm.",
  ...
  const confirmDueSizeHtml = oversizeConfirm
    ? `<p style="margin:0 0 10px;padding:12px 14px;background:#fff1f0;border-left:4px solid #c0392b;font-size:14px;line-height:1.55;color:#333;"><strong>Needs confirmation due to item size.</strong> At least one item is 299+ lb or over 72&quot; high or 72&quot; wide. Confirm pricing before scheduling. <strong>This is an estimate only.</strong></p>`
    : "";

  const confirmDueDistanceHtml = longHaulConfirm
    ? `<p style="margin:0 0 10px;padding:12px 14px;background:#fff1f0;border-left:4px solid #c0392b;font-size:14px;line-height:1.55;color:#333;"><strong>Needs confirmation — out of town (100+ mile round trip).</strong> Confirm pricing before scheduling. <strong>This is an estimate only.</strong></p>`
    : "";
  ...
  const estimateHtml = localPriceDisplay
    ? [
        ...
        `<p style="margin:0 0 10px;padding:12px 14px;background:#fff8e8;border-left:4px solid #c9a227;font-size:15px;line-height:1.55;color:#333;"><strong>Confirm pricing before scheduling.</strong> This is an estimate from our online tool. A PDF of your submitted answers is attached — review your questions and make sure all information and access details are accurate when you call to confirm.</p>`,
      ].join("")
    : isLocal
  ...
  const buyPolicyHtml = isPickup
    ? [
        ...
        `<p style="margin:0;font-size:14px;line-height:1.6;color:#333;">Confirm pricing before scheduling. This is an estimate from our online tool. Review the attached PDF of your answers and make sure they are accurate when you call to confirm.</p>`,
        `</div>`,
      ].join("")
    : isLocal
      ? [
          ...
          `<p style="margin:0 0 ${buyNowHtml ? "14px" : "0"};font-size:14px;line-height:1.6;color:#333;">We do <strong>not hold items</strong>. Purchase now and we can confirm delivery shortly. Confirm pricing before scheduling — this is an estimate from our online tool. Review your attached PDF and make sure your answers are accurate when you call.</p>`,
          buyNowHtml || "",
          `</div>`,
        ].join("")
      : [
  ...
  const buyPolicyText = isPickup
    ? [
        ...
        "Confirm pricing before scheduling. This is an estimate from our online tool. Review the attached PDF of your answers and make sure they are accurate when you call to confirm.",
      ].join("\n")
    : isLocal
      ? [
          "Ready to purchase?",
          "We do not hold items. Purchase now and we can confirm delivery shortly. Confirm pricing before scheduling — this is an estimate from our online tool. Review your attached PDF and make sure your answers are accurate when you call.",
          buyUrlsText || null,
        ]
          .filter(Boolean)
          .join("\n")
  ...
  const customerHtml = wrapEmail(
    [
      ...
      isLocal
        ? `<p style="margin:0 0 14px;font-size:14px;color:#444;"><strong>Confirm pricing before scheduling.</strong> This is an estimate from our online tool — not a booking. Review the attached PDF of your questions and make sure everything is accurate when you call to confirm.</p>`
        : `<p style="margin:0 0 14px;font-size:14px;color:#444;">This is an estimate from our online tool — not a booking. Review the attached PDF of your answers and make sure they are accurate when you call to confirm pricing.</p>`,
  ...
  const customerText = [
    ...
    localPriceDisplay
      ? `${estimateAmountLabel}\n${localPriceDisplay} (Estimate)${
          oversizeConfirm
            ? "\nNeeds confirmation due to item size (299+ lb or over 72\" H or over 72\" W). Confirm pricing before scheduling. ESTIMATE ONLY."
            : ""
        }${
          longHaulConfirm
            ? "\nNeeds confirmation — out of town (100+ mile round trip). Confirm pricing before scheduling. ESTIMATE ONLY."
            : ""
        }\nConfirm pricing before scheduling. This is an estimate from our online tool. Review the attached PDF of your answers and make sure they are accurate when you call to confirm.`
      : isLocal
