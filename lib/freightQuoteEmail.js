...
function nationwideInternalPlaybookHtml(submission = {}) {
  ...
  const customerSaid = [
    ...
    "Origin loading without liftgate: Lost & Found to confirm (most pallet freight cannot)",
