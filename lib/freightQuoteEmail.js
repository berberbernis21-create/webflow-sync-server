...
function nationwideInternalPlaybookText(submission = {}) {
  ...
  return [
    ...
    `2) Forward this email to Luke Rogers <${FREIGHTCENTER_LUKE_EMAIL}> and ask for options: cheapest, best/quality, warehouse pickup, and other good alternatives.`,
    `Compare your quick quote with Luke's options before replying to the customer. Phone: ${FREIGHTCENTER_PHONE}.`,
    "",
