...
function socialFollowHtml({ isPickup }) {
  ...
  return [
    ...
    `<p style="margin:0 0 6px;font-size:11px;font-weight:800;letter-spacing:0.08em;text-transform:uppercase;color:${NAVY};">Follow Lost &amp; Found</p>`,
    `<p style="margin:0 0 14px;font-size:14px;line-height:1.55;color:#333;">${escapeHtml(intro)}</p>`,
    `<p style="margin:0 0 10px;font-size:13px;font-weight:800;color:${NAVY};">Lost &amp; Found Resale</p>`,
    `<div>${socialLinkButton(SOCIAL.resaleFacebook, "Facebook", { bg: "#3b5998", color: "#ffffff", border: "#3b5998" })}</div>`,
    `<p style="margin:16px 0 8px;font-size:13px;font-weight:800;color:${NAVY};">Also check out our luxury division</p>`,
    ...
    `<div>`,
    socialLinkButton(SOCIAL.luxurySite, "Shop Luxury"),
