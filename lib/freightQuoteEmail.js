  ...
  const estimateLine =
    isLocal && localEstimate?.estimated_price != null
      ...
      : isLocal
        ...
        : nationwideRangeText
          ? `Your preliminary nationwide freight range is <strong>${escapeHtml(
              nationwideRangeText
            )}</strong>.`
          : `We received your nationwide freight request.`;

  const estimateHtml = isLocal
    ? `<p style="margin:0 0 10px;font-size:15px;line-height:1.55;color:#333;">${estimateLine}</p>`
    : nationwideRangeText
      ? [
      ...
      : `<p style="margin:0 0 10px;font-size:15px;line-height:1.55;color:#333;">${estimateLine} Our team will review your request and email you a confirmed quote.</p>`;
  ...
  const customerText = [
    ...
    isLocal && localEstimate?.estimated_price != null
      ...
      : isLocal
        ...
        : nationwideRangeText
          ? `Your preliminary nationwide freight range is ${nationwideRangeText}. Our team will review your request and email you a confirmed quote.`
