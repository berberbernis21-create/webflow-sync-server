...
export function buildFreightQuoteEmails(submission, ctx = {}) {
  ...
  const driveExplainHtml =
    isLocal && oneWayMinutes != null
      ...
      : isLocal
        ...
        : `<p style="margin:0 0 14px;font-size:14px;color:#444;">This preliminary range accounts for pallet dimensions and weight, distance${
            nationwideMiles != null ? ` (about <strong>${nationwideMiles} miles</strong> from our Scottsdale showroom)` : ""
          }, residential/commercial delivery, liftgate, and handling needs. Nationwide freight is never quoted below <strong>$350</strong>; white-glove services (inside delivery, room placement, unpacking, assembly, or extra crew) can increase the upper end.</p>`;
  ...
  const driveExplainText =
    isLocal && oneWayMinutes != null
      ...
      : isLocal
        ...
        : `This preliminary range accounts for pallet dimensions and weight, distance${
            nationwideMiles != null ? ` (about ${nationwideMiles} miles from our Scottsdale showroom)` : ""
          }, residential/commercial delivery, liftgate, and handling needs. Nationwide freight is never quoted below $350; white-glove services can increase the upper end.`;
  ...
  const customerHtml = wrapEmail(
    [
      ...
      isLocal
        ? ""
        : `<p style="margin:0 0 12px;font-size:14px;color:#444;"><strong>This is an estimate only.</strong> We will follow up with a direct quote and contact our freight partners to give you an exact quote as well. Confirmed carrier pricing and the Shipment ID come after that review. You can also reach FreightCenter at ${FREIGHTCENTER_PHONE} once we provide that ID. Lost &amp; Found does not book the shipment for you.</p>`,
  ...
  const customerText = [
    ...
    !isLocal
      ? "We will follow up with a direct quote and contact our freight partners to give you an exact quote as well."
      : null,
    "",
    "Your item(s):",
