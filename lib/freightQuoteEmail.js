...
export function buildFreightQuoteEmails(submission, ctx = {}) {
  ...
  const timingNoteHtml = isLocal
    ? isPickup
      ? `<p style="margin:0 0 12px;padding:12px 14px;background:#f4f7fb;border-left:4px solid #1f4e79;font-size:14px;line-height:1.55;color:#333;"><strong>Typical timing:</strong> Same-day pickup can sometimes be arranged when coordinated early in the day; most local pickups are next-day once confirmed. Once arrangements are set, we can push to coordinate promptly.</p>`
      : `<p style="margin:0 0 12px;padding:12px 14px;background:#f4f7fb;border-left:4px solid #1f4e79;font-size:14px;line-height:1.55;color:#333;"><strong>Typical timing:</strong> Same-day local delivery can sometimes be arranged when coordinated early in the day; most local items are next-day once purchased and we push to coordinate. After you buy the item, we can push scheduling promptly.</p>`
    : `<p style="margin:0 0 12px;padding:12px 14px;background:#f4f7fb;border-left:4px solid #1f4e79;font-size:14px;line-height:1.55;color:#333;"><strong>Typical timing:</strong> Nationwide freight is typically 3–5 business days across the country after booking (varies by carrier and destination). Once your item is purchased, we can push to coordinate freight promptly.</p>`;

  const timingNoteText = isLocal
    ? isPickup
      ? "Typical timing: Same-day pickup can sometimes be arranged when coordinated early in the day; most local pickups are next-day once confirmed. Once arrangements are set, we can push to coordinate promptly."
      : "Typical timing: Same-day local delivery can sometimes be arranged when coordinated early in the day; most local items are next-day once purchased and we push to coordinate. After you buy the item, we can push scheduling promptly."
    : "Typical timing: Nationwide freight is typically 3–5 business days across the country after booking (varies by carrier and destination). Once your item is purchased, we can push to coordinate freight promptly.";
