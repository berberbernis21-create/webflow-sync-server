...
export function buildFreightQuoteEmails(submission, ctx = {}) {
  ...
  const customerHtml = wrapEmail(
    [
      ...
      isLocal
        ? ""
        : `<p style="margin:18px 0 12px;font-size:14px;color:#444;">Nationwide ranges are wide because every carrier prices freight differently. You can contact <strong>FreightCenter</strong> directly at <a href="tel:${FREIGHTCENTER_PHONE.replace(/\D/g, "")}" style="color:${NAVY};font-weight:700;">${FREIGHTCENTER_PHONE}</a> for a same-day check, <strong>or</strong> we will email you full rates once our team reviews your request with our trusted human partner in the loop.</p>
           <p style="margin:0 0 12px;font-size:14px;color:#444;">White Glove / Room of Choice raise cost significantly; warehouse/terminal pickup usually saves about $150–$200 (we will mention this even if you did not select it). If you follow through with pickup or loading at Lost &amp; Found, our hours are <strong>10am–5pm, Monday–Saturday</strong>.</p>`,
  ...
  const customerText = [
    ...
    !isLocal
      ? "Nationwide ranges are wide — every carrier prices differently. Contact FreightCenter at 800-716-7608 for a same-day check, or we will email you full rates after our team reviews. Lost & Found pickup/loading hours: 10am–5pm, Monday–Saturday. Warehouse/terminal pickup usually saves about $150–$200."
      : null,
    "",
    "Your item(s):",
