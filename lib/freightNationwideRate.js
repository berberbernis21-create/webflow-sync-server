...
function followUpMessage({ miles, measured }) {
  ...
  return (
    `Preliminary nationwide freight range based on distance, pallet size/weight, and the options you selected.${distanceBit}` +
    " Ranges are wide because every carrier prices freight differently." +
    " We will get you a quote — our team will review your request and email you full rates. You can also contact FreightCenter directly anytime at 800-716-7608." +
    " White Glove and Room of Choice raise the quote significantly; warehouse/terminal pickup near you typically saves about $150–$200; no liftgate at delivery and store loading at our end also help." +
    " If you pick up or we load at Lost & Found, our hours are 10am–5pm, Monday–Saturday."
  );
}
...
export async function fetchNationwideLiveRate(submission = {}) {
  ...
  return {
    ...
    follow_up:
      "We will get you a quote — our team will review your request and email you full rates. You can also contact FreightCenter anytime at 800-716-7608. Lost & Found pickup/loading hours: 10am–5pm, Monday–Saturday. Warehouse/terminal pickup usually saves about $150–$200.",
  };
}
