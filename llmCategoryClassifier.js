...
- **Chandelier**, sconce, pendant light, **floor lamp**, torchiere → "Lighting". **Table lamp**, **desk lamp**, and **bedside lamp** → **"Accessories"** (this catalog; not LivingRoom because of showroom copy). Do not use LivingRoom for these.
...
- Vases, **tray** / **trays** (decorative, serving, pedestal tray — not **tray table** furniture), bowls / **pedestal bowl**, **fruit bowl**, compotes, wood or ceramic decorative bowls, **scroll box** / document box, lidded vanity boxes, pillows, clocks, picture frames (empty), trinkets, **home decor** tabletop pieces → "Accessories" (small decor only — not wall storage furniture). Pedestal != pedestal **dining table**. Copy about dining or living **rooms** does **not** recategorize a bowl to DiningRoom or LivingRoom. If **vase**, **pedestal bowl**, or **tray** (non-tray-table) is in the title → **Accessories**, never LivingRoom.
