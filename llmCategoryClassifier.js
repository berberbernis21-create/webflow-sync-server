...
- Vases, trays, bowls / **pedestal bowl**, **fruit bowl**, compotes, wood or ceramic decorative bowls, **scroll box** / document box, lidded vanity boxes, pillows, clocks, picture frames (empty), trinkets, **home decor** tabletop pieces → "Accessories" (small decor only — not wall storage furniture). Pedestal != pedestal **dining table**. Copy about dining or living **rooms** does **not** recategorize a bowl to DiningRoom or LivingRoom. If **vase** or **pedestal bowl** is in the title → **Accessories**, never LivingRoom.
