...
export const CATEGORY_KEYWORDS_FURNITURE = {
  LivingRoom: [
    ...
    "bench", "benches", "entry bench", "entryway bench", "mudroom bench", "storage bench",
    "settle bench", "hall bench", "bed bench", "bedroom bench", "wood bench", "rustic bench",
  ...
  OutdoorPatio: [
    ...
    "outdoor bench", "outdoor benches", "patio bench", "patio benches", "garden bench", "garden benches", "porch bench",
